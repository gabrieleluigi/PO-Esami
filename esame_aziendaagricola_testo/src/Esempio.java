...
public class Esempio {
	...
	public static void main(String[] args) throws ColtivazioneDuplicataException, ProdottoNonCompatibileException {
		...
		Zona zd = a.aggiungiZona();
		zd.setAmpiezza(1000);
		System.out.println("\nAggiunta zona "+zd.getCodice());
		...
		Fertilizzante f3= c.richiedeFertilizzante('N', "LLetame", 20, 4, 60);
		...
		System.out.println(" Richiede: "+f3.getNome());
		...
		Raccolto ra = za.nuovoRaccolto("Fagiolini", "2012-08-28", 900);
 		...
 		Raccolto rd = za.nuovoRaccolto("Fagiolini1200", "2012-09-02", 1200);
