...
public class Associazione {
	...
	public Incontro nuovoIncontroTorneo(String nomeTorneo, String idGiocatore1, String idGiocatore2, int turno) {
		...
		mappaTornei.get(nomeTorneo).addIncontro(i,turno);
		String key = nomeTorneo+" "+turno;
		mappaGiocatoriID.get(idGiocatore1).addIncontro(i,key);
		mappaGiocatoriID.get(idGiocatore2).addIncontro(i,key);
		return i;
	}
